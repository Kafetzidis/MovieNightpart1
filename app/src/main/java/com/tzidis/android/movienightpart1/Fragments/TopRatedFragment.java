...
import com.tzidis.android.movienightpart1.MainActivity;
...
public class TopRatedFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Movie>>{
    ...
    private static final String BASE_REQUEST_URL_TOP_RATED =
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (isConnected()) {
            ...
            Uri builtUri = Uri.parse(BASE_REQUEST_URL_TOP_RATED)
                    .buildUpon()

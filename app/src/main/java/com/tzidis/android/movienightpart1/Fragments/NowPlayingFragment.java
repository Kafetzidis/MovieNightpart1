...
public class NowPlayingFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Movie>>{
    ...
    private static final String BASE_REQUEST_URL_NOW_PLAYING =
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (isConnected()) {
            ...
            Uri builtUri = Uri.parse(BASE_REQUEST_URL_NOW_PLAYING)
                    .buildUpon()

...
public class UpcomingFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Movie>>{
    ...
    private static final String BASE_REQUEST_URL_UPCOMING =
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (isConnected()) {
            ...
            Uri builtUri = Uri.parse(BASE_REQUEST_URL_UPCOMING)
                    .buildUpon()
